                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" value="${video != null ? video.title : ''}" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="href">Href</label>
                                    <input type="text" id="href" value="${video != null ? video.href : ''}" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-9">
                                            <div class="row">
                                                ...
                                                <div class="col-12 form-group">
                                                    ...
                                                    <input type="text" id="poster" value="${video != null ? video.poster : ''}" class="form-control" required>
...
<script>
    var titleD, hrefD, descriptionD, posterD;
    $(document).ready(function () {
        titleD = $('#title').val();
        hrefD = $('#href').val();
        descriptionD = $('#description').val();
        posterD = $('#poster').val();
    });
    ...
    $('#resetBtn').click(function () {
        $('#title').val(titleD);
        $('#href').val(hrefD);
        $('#description').val(descriptionD);
        $('#poster').val(posterD);
        if(posterD.length > 0){
            $('#imgPreview').attr('src', posterD);
        }
    });
    ...
    $('#submitBtn').click(function () {
        ...
        if(isEdit == 'true'){
            url = '/AssJava4_war_exploded/admin/video?action=edit&href=' + hrefD;
        }else{
            url = '/AssJava4_war_exploded/admin/video?action=add';
        }
        var formData = {
            'hrefD' : hrefD,
            'title' : $('#title').val(),
        ...
        $.ajax({
            ...
            console.log(data);
            window.location.href = 'http://localhost:8080/AssJava4_war_exploded/admin/video?action=view';
        }).fail(function (error) {
            $('#message').text("Fail!");
        });
    });
