                        ...
                        <tbody>
                            <c:forEach items="${videos}" var="item">
                                <tr>
                                    ...
                                    <td style="text-align: center"><a href="video?action=watch&id=${item.href}">${item.href}</a></td>
                                    <td style="text-align: center">
                                        <img src="${item.poster}" width="80px" height="50px" class="rounded rounded-3" alt="">
                                    </td>
                                    <td style="text-align: center; white-space: nowrap">
                                        <a href="<c:url value='/admin/video?action=edit&href=${item.href}'/> " type="button" class="btn btn-warning btn-sm btn-block">Edit</a>
                                        <button type="button" onclick="deleteVideo('${item.href}')" class="btn btn-danger btn-sm btn-block">Delete</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
...
<script>
    function deleteVideo(href){
        ...
        $.ajax({
            url: '/AssJava4_war_exploded/admin/video?action=delete&href=' + href
        }).then(function (data) {
