        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Favorites Video</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <c:forEach items="${videoLikedInfos}" var="item">
                                <tr>
                                    <td>${item.title}</td>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="">List Video</label>
                        <select name="" class="form-control" id="selectVideo">
                            <option selected disabled>Select Option</option>
                            <c:forEach items="${videoLikedInfos}" var="video">
